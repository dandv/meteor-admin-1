  ...
  AutoForm.hooks({
    admin_insert: {
      onSubmit: function(insertDoc, updateDoc, currentDoc) {
        Meteor.call('adminInsertDoc', insertDoc, Session.get('admin_collection'), function(e, r) {
          if (e) {
    ...
    admin_update: {
      onSubmit: function(insertDoc, updateDoc, currentDoc) {
        Meteor.call('adminUpdateDoc', updateDoc, Session.get('admin_collection'), Session.get('admin_id'), function(e, r) {
          if (e) {
            console.log(e);
            return AdminDashboard.alertFailure('Error: ' + e);
          } else {
            ...
            AutoForm.resetForm('admin_insert');
            $('.btn-primary').removeClass('disabled');
            return Router.go('/admin/' + Session.get('admin_collection'));
          }
        });
        return false;
      },
